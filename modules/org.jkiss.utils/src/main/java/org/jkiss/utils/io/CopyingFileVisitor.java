...
/**
 * Copies files from a source directory to a target directory, preserving the directory structure.
 */
public class CopyingFileVisitor extends SimpleFileVisitor<Path> {
    private final Path sourceRoot;
    private final Path targetRoot;

    public CopyingFileVisitor(@NotNull Path sourceRoot, @NotNull Path targetRoot) {
    ...
    @NotNull
    protected Path resolveTargetPath(@NotNull Path sourcePath) {
